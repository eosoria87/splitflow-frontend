...
const CreateGroupCard = () => {
  return (
    <button className="w-full h-full min-h-[160px] rounded-2xl border-2 border-dashed border-slate-200 hover:border-teal-500/50 hover:bg-teal-50/30 transition-colors flex flex-col items-center justify-center gap-3 group cursor-pointer">
