	...
	return (
		<div className="xl:hidden">
			...
			>
				...
				{/* Drawer Footer (Settings & Profile) */}
				<div className="p-4 border-t border-slate-200 flex flex-col gap-2">
					...
					<div className="flex items-center gap-3 px-4 py-3 mt-2 cursor-pointer hover:bg-slate-100 rounded-xl transition-colors">
						<img src="https://i.pravatar.cc/150?img=68" alt="Alex Morgan" className="w-10 h-10 rounded-full border border-slate-200 object-cover shrink-0" />
						<div className="flex flex-col overflow-hidden">
							<span className="text-sm font-bold text-left text-slate-900 truncate">Alex Morgan</span>
