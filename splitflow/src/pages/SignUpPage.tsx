			...
			<div className="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] w-full p-8 sm:p-10 border border-slate-100">
				...
				<form action="" onSubmit={handleSubmit(onSubmit)} className="space-y-5 mt-6">
						<div>
							...
							{errors.name?.type === 'required' && <p className="text-red-500 text-sm mt-1">The name field is required.</p>}
							{errors.name?.type === 'minLength' && <p className="text-red-500 text-sm mt-1">The name must be at least 3 characters.</p>}
						</div>
						<div>
