			...
			<main className="flex-1 flex flex-col min-h-screen pt-2">
				...
				<MainContainer columnsNum={2}>
						...
						<div className="space-y-4">
							{isFetching ? (
								Array.from({ length: 2 }).map((_, i) => (
									<div key={i} className="h-30 w-full bg-slate-100 animate-pulse rounded-2xl border border-slate-200"></div>
								))
					...
					<section className="bg-teal-50/50 border border-teal-100 rounded-3xl p-8 flex flex-col md:flex-row items-center justify-between gap-8 xl:col-span-2">
						...
						{isFetching ? (
							<div className="w-48 h-48 rounded-full bg-teal-100/50 animate-pulse flex items-center justify-center shrink-0">
